...
const registerTFIMaterialRecipes = (event) => {
    ...
    if (!dustItem.isEmpty() && tfcProperty !== null) {
    ...
    if (tfcProperty !== null && !boltItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !screwItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !ringItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !springItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !smallSpringItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !nuggetItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !smallGearItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !gearItem.isEmpty()) {
    ...
    if (tfcProperty !== null && !buzzsawBladeItem.isEmpty()) {
