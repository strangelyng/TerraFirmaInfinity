...
const registerTFIMaterialRecipes = (event) => {
    ...
    let recipesToRemove = [
        'tfc:heating/bell',
        'tfc:heating/brass_bell',
        'tfc:heating/bronze_bell'
    ]
    ...
    forEachMaterial(material => {
        ...
        processPlatedBlock(event, material); // Moved outside because Chromium and Stainless Steel (Firmalife) do not have a TFC_PROPERTY
        ...
        if (material.hasProperty(PropertyKey.ORE)) {
            ...
            // createPainfulOreSmeltingRecipes(event, material);
        }
    })
}