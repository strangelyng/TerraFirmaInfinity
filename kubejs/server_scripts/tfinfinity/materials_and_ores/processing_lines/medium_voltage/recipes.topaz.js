const registerTFITopazGroupRecipes = (event) => {
    ...
    // event.recipes.gtceu.chemical_reactor('blue_topaz_sludge_sulfuric_acid_process')
    ...
    event.recipes.gtceu.chemical_reactor('blue_topaz_sludge_hydrochloric_acid_process')
        .itemInputs('10x tfinfinity:blue_topaz_sludge_residue_dust')
    ...
    // event.recipes.gtceu.chemical_reactor('topaz_sludge_sulfuric_acid_process')
    ...
    event.recipes.gtceu.chemical_reactor('topaz_sludge_hydrochloric_acid_process')
        .itemInputs('10x tfinfinity:topaz_sludge_residue_dust')
        .inputFluids('6000x gtceu:hydrochloric_acid')
        .itemOutputs('3x gtceu:silicon_dioxide_dust')
        .outputFluids('3000x gtceu:salt_water')
