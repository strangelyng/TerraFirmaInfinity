...
const registerTFIMaterialModificationProperties = (event) => {
    ...
    // Base TFC Ores
    InfinityMaterials.Bismuthinite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(270, 0.14, GTMaterials.Bismuth, 1, 75)); // Sulfide : 40

    GTMaterials.Cassiterite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(230, 0.14, GTMaterials.Tin, 1, 90)); // Oxide : 33.33

    GTMaterials.Garnierite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1453, 0.48, GTMaterials.Nickel, 1, 90)); // Oxide : 50

    GTMaterials.Hematite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 90)); // Oxide : 40
    GTMaterials.YellowLimonite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 80)); // Hydroxide : 25
    GTMaterials.Magnetite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 90)); // Oxide : 42.857

    GTMaterials.Malachite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1080, 0.35, GTMaterials.Copper, 1, 75)); // Carbonate Hydroxide : 20
    GTMaterials.Tetrahedrite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1080, 0.35, GTMaterials.Copper, 1, 75)); // Sulfosalt : 28.57

    GTMaterials.Sphalerite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(420, 0.21, GTMaterials.Zinc, 1, 75)); // Sulfide : 50

    // GT Ores
    GTMaterials.CassiteriteSand.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(230, 0.14, GTMaterials.Tin, 1, 50)); // Sand : 33.33

    GTMaterials.Bornite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1080, 0.35, GTMaterials.Copper, 1, 75)); // Sulfide : 50
    GTMaterials.Chalcopyrite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1080, 0.35, GTMaterials.Copper, 1, 75)); // Sulfide : 25
    GTMaterials.Chalcocite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1080, 0.35, GTMaterials.Copper, 1, 75)); // Sulfide : 66.67

    GTMaterials.Cobaltite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1495, 0.35, GTMaterials.Cobalt, 1, 75)); // Sulfide : 33.33

    GTMaterials.Galena.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(327, 0.14, GTMaterials.Lead, 1, 75)); // Sulfide : 50

    GTMaterials.Pentlandite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1453, 0.48, GTMaterials.Nickel, 1, 75)); // Sulfide : 52.94

    GTMaterials.Goethite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 80)); // Hydroxide : 25
    GTMaterials.Pyrite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 75)); // Sulfide : 33.33
    GTMaterials.VanadiumMagnetite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 90)); // Oxide : 21.42857
    GTMaterials.GraniticMineralSand.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 50)); // Sand : 21.42857
    GTMaterials.BasalticMineralSand.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 3, 50)); // Sand : 21.42857

    // Infinity Ores
    InfinityMaterials.Acanthite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(961, 0.48, GTMaterials.Silver, 1, 75)); // Sulfide : 66.67
    InfinityMaterials.Arsenopyrite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1535, 0.35, GTMaterials.Iron, 1, 75)); // Sulfide : 33.33
    InfinityMaterials.Millerite.setProperty(InfinityPropertyKey.TFC_PROPERTY, new $TFC_PROPERTY(1453, 0.48, GTMaterials.Nickel, 1, 75)); // Sulfide : 50
}